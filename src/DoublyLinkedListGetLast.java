...
public class DoublyLinkedListGetLast<E> {
     ...
     */
    public DoublyLinkedListGetLast() {
    }
    ...
    protected void linkFirst(E e) {
        final DoublyLinkedListGetLast.Node<E> f = first;
        final DoublyLinkedListGetLast.Node<E> newNode = new DoublyLinkedListGetLast.Node<>(null, e, f);
        first = newNode;
        if (f == null)
            last = newNode;
        else
     ...
     */
    public E removeLast() {
        final DoublyLinkedListGetLast.Node<E> l = last;
        if (l == null)
            throw new NoSuchElementException();
        return unlink(last);
    }
