...
public class DoublyLinkedListGet<E> {
    ...
    protected void linkFirst(E e) {
        final DoublyLinkedListGet.Node<E> f = first;
        final DoublyLinkedListGet.Node<E> newNode = new DoublyLinkedListGet.Node<>(null, e, f);
        first = newNode;
        if (f == null)
            last = newNode;
        else
     ...
     */
    public E removeLast() {
        final DoublyLinkedListGet.Node<E> l = last;
        if (l == null)
            throw new NoSuchElementException();
        return unlink(last);
    }
