...
public class DoublyLinkedListAdd<E> {
    ...
    protected void linkFirst(E e) {
        final DoublyLinkedListAdd.Node<E> f = first;
        final DoublyLinkedListAdd.Node<E> newNode = new DoublyLinkedListAdd.Node<>(null, e, f);
        first = newNode;
        if (f == null)
            last = newNode;
        else
     ...
     */
    public E removeLast() {
        final DoublyLinkedListAdd.Node<E> l = last;
        if (l == null)
            throw new NoSuchElementException();
        return unlink(last);
    }
