...
public class DoublyLinkedListGetFirst<E> {
     ...
     */
    public DoublyLinkedListGetFirst() {
    }
    ...
    protected void linkFirst(E e) {
        final DoublyLinkedListGetFirst.Node<E> f = first;
        final DoublyLinkedListGetFirst.Node<E> newNode = new DoublyLinkedListGetFirst.Node<>(null, e, f);
        first = newNode;
        if (f == null)
            last = newNode;
        else
     ...
     */
    public E removeLast() {
        final DoublyLinkedListGetFirst.Node<E> l = last;
        if (l == null)
            throw new NoSuchElementException();
        return unlink(last);
    }
